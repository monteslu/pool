        ...
        draw: function(ctx){
          if(!this.offScrCanvas){
            ...
            for(var i = 0; i < degrees; i++){
              ...
              octx.beginPath();
              octx.arc((i * this.radius * 2 * SCALE) + (this.radius * SCALE) ,
               this.radius * SCALE, 
               this.radius * SCALE, 0, Math.PI * 2, true);  
              ...
              octx.beginPath();
              octx.arc((i * this.radius * 2 * SCALE) + (this.radius * SCALE) ,
                   this.radius * SCALE,  this.radius * SCALE, 0, Math.PI * 2, true);          
              octx.closePath();
              octx.stroke();
          ...
          if(this.id != 0){
			 ...
			 if(this.id < 10){
				textXOffset = this.x * SCALE - this.radius * SCALE/2 + 3;
			 }else{
				textXOffset = this.x * SCALE - this.radius * SCALE/2;
			 }
			  
			  ctx.fillText(this.id,textXOffset,this.y * SCALE - this.radius * SCALE /2 + 10);
			  
	          if(this.striped){
				  
		          ctx.beginPath();
	              ctx.arc(this.x * SCALE, this.y * SCALE, this.radius * SCALE, Math.PI * 1.77, Math.PI * 1.22 , true);          
	              ctx.closePath();
	              ctx.fill();
	              
	              ctx.beginPath();
	              ctx.arc(this.x * SCALE, this.y * SCALE, this.radius * SCALE, Math.PI * 0.77, Math.PI * 0.22 , true);          
	              ctx.closePath();
	              ctx.fill();
	          }	          
