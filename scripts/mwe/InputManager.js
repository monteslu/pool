...
define(['./GameAction', 'dojo/_base/declare', 'dojo/_base/connect', 'dojo/dom-geometry'], function(GameAction, declare, connect, domGeom){
  ...
  return declare(null, {
    ...
    constructor: function(args){
      ...
      connect.connect(document, 'onkeydown', this, this.keyPressed);
      connect.connect(document, 'onkeyup', this, this.keyReleased);
      connect.connect(this.canvas, 'onmousedown', this, this.mouseDown);
      connect.connect(document, 'onmouseup', this, this.mouseUp);
      connect.connect(this.canvas, 'onmousemove', this, this.mouseMove);

      connect.connect(document, 'ontouchend', this, this.touchEnd);
      connect.connect(this.canvas, 'ontouchstart', this, this.touchStart);
      connect.connect(this.canvas, 'ontouchmove', this, this.touchMove);
    },
    /**
